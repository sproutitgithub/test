def get_insights(sproutemailaddress,insightspassword):
    import os
    import shutil
    ...
    pag.press(['enter'])
    time.sleep(2)
    pag.click(852,537) # click the user name 
    time.sleep(2)
    pag.write(insightspassword) # type the password
    pag.press(['enter'])
    time.sleep(3)
